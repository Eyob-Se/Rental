        ...
        <div class="container">
            ...
            <div class="modal" id="houseFormModal" style="display:none;">
                <div class="modal-content">
                    ...
                    <form id="houseForm" method="POST" enctype="multipart/form-data" action="upload_house_process.php">
                        ...
                        <textarea name="description" id="description" placeholder="Brief Description" rows="3"
                            required></textarea>
            ...
            <table class="user-table" id="uploadedTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" style="text-align:center;">No houses uploaded yet.</td>
                    </tr>
                    <?php else: ?>
              ...
              ?>
                            <span
                                class="status <?= $statusClass ?>"><?= htmlspecialchars(ucfirst($house['status'])) ?></span>
                        </td>
                        <td class="actions">
            ...
            <table class="user-table" id="rentedTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" style="text-align:center;">No rented houses yet.</td>
                    </tr>
                    <?php else: ?>
