                    ...
                    <?php if (!empty($leases)): ?>
                        <?php foreach ($leases as $lease): ?>
                            <tr>
                                ...
                                <td><?= $lease['signed_by_tenant'] == 1 ? date("F j, Y", strtotime($lease['signed_at'])) : 'Not signed' ?></td>
                                <td>
...
<div id="leaseModal" class="modal">
    <div class="modal-content" id="modalContent">
        ...
        <button class="btn" id="downloadBtn" style="background:green; display:none;" onclick="downloadPDF()">Download PDF</button>
