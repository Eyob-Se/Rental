...
<body>
    <div class="prop_con">
        ...
        <button class="btn" style="margin: 2rem 0rem 0rem 18rem;" onclick="window.location.href='dashboard.php'">Back to
            dashboard</button>
        ...
        <div class="cards">
            ...
            <div class="card">
                ...
                <img src="../uploads/house_images/<?= htmlspecialchars($house['image_path'] ?: 'default.jpg') ?>"
